        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZipCode = table.Column<int>(type: "int", unicode: false, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fuel = table.Column<string>(type: "varchar(25)", unicode: false, maxLength: 25, nullable: false),
                    Blocked = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfDoors = table.Column<int>(type: "int", nullable: true, defaultValue: 0)
                },
                constraints: table =>
                {
