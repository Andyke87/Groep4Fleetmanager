...
export const DropdownVoertuigen = ({selectedIdVehicle, setSelectedIdVehicle}) => 
{
  ...
  const handleVehicleChange = (event) => {
    ...
    setSelectedIdVehicle(parseInt(selectedIdVehicle));
  ...
  return (
    <div>
      <select className="dropDown" onChange={handleVehicleChange}>
        <option value={selectedIdVehicle}>Select a vehicle id</option>
